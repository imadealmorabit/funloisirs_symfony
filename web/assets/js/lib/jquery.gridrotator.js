! function(t, e, o) {
    ...
    a = h.special.debouncedresize = {
        ...
        handler: function(t, e) {
            ...
            r && clearTimeout(r), e ? i() : r = setTimeout(i, a.threshold)
        },
        threshold: 100
    ...
    t.GridRotator = function(e, o) {
        ...
        _config: function() {
            ...
            i.each(function() {
                var o = t(this),
                    a = o.attr("src");
                t("<img/>").load(function() {
                    ++s, o.parent().css("background-image", "url(" + a + ")"), s === n && (i.remove(), e.$el.removeClass("ri-grid-loading"), e.$items = e.$list.children("li"), e.$itemsCache = e.$items.clone(), e.itemsTotal = e.$items.length, e.outItems = [], e._layout(function() {
                        e._initEvents(), e.options.resize()
                    }), e._start())
                }).attr("src", a)
            })
        },
        _layout: function(e) {
            ...
            var s = this.$items.filter(":gt(" + (this.showTotal - 1) + ")"),
                i = s.children("a");
            this.outItems.length = 0, i.each(function() {
                o.outItems.push(t(this))
            }), s.remove();
            for (var n = document.defaultView ? parseInt(document.defaultView.getComputedStyle(this.$el.get(0), null).width) : this.$el.width(), a = Math.floor(n / this.columns), r = n - this.columns * Math.floor(a), h = 0; h < this.rows; ++h)
                for (var d = 0; d < this.columns; ++d) {
                    var c = this.columns * h + d,
                        l = this.$items.eq(c);
                    l.css({
                        width: d < Math.floor(r) ? a + 1 : a,
                        height: a
        ...
        _setGridDim: function() {
            ...
            switch (!0) {
                ...
                case 1024 > t:
                    ...
                    break;
                case 1400 > t:
                    this.rows = this.options.w1400.rows, this.columns = this.options.w1400.columns;
                    break;
                default:
        ...
        _getAnimProperties: function(t) {
            ...
            switch (r) {
                ...
                case "fadeInOut":
                    ...
                    break;
                case "slideLeft":
                    s.left = t.width(), n.left = 0, a.left = -t.width();
                    break;
                case "slideRight":
                    s.left = -t.width(), n.left = 0, a.left = t.width();
                    break;
                case "slideTop":
                    s.top = t.height(), n.top = 0, a.top = -t.height();
                    break;
                case "slideBottom":
                    s.top = -t.height(), n.top = 0, a.top = t.height();
                    break;
                case "rotateLeft":
                    e = this.options.animSpeed / 2, s.transform = "rotateY(90deg)", n.transform = "rotateY(0deg)", h = e, a.transform = "rotateY(-90deg)";
                    break;
                case "rotateRight":
                    e = this.options.animSpeed / 2, s.transform = "rotateY(-90deg)", n.transform = "rotateY(0deg)", h = e, a.transform = "rotateY(90deg)";
                    break;
                case "rotateTop":
                    e = this.options.animSpeed / 2, s.transform = "rotateX(90deg)", n.transform = "rotateX(0deg)", h = e, a.transform = "rotateX(-90deg)";
                    break;
                case "rotateBottom":
                    e = this.options.animSpeed / 2, s.transform = "rotateX(-90deg)", n.transform = "rotateX(0deg)", h = e, a.transform = "rotateX(90deg)";
                    break;
                case "scale":
                    e = this.options.animSpeed / 2, s.transform = "scale(0)", i.transform = "scale(1)", n.transform = "scale(1)", h = e, a.transform = "scale(0)";
                    break;
                case "rotateLeftScale":
                    i.transform = "scale(1)", e = this.options.animSpeed / 2, s.transform = "scale(0.3) rotateY(90deg)", n.transform = "scale(1) rotateY(0deg)", h = e, a.transform = "scale(0.3) rotateY(-90deg)";
                    break;
                case "rotateRightScale":
                    i.transform = "scale(1)", e = this.options.animSpeed / 2, s.transform = "scale(0.3) rotateY(-90deg)", n.transform = "scale(1) rotateY(0deg)", h = e, a.transform = "scale(0.3) rotateY(90deg)";
                    break;
                case "rotateTopScale":
                    i.transform = "scale(1)", e = this.options.animSpeed / 2, s.transform = "scale(0.3) rotateX(90deg)", n.transform = "scale(1) rotateX(0deg)", h = e, a.transform = "scale(0.3) rotateX(-90deg)";
                    break;
                case "rotateBottomScale":
                    i.transform = "scale(1)", e = this.options.animSpeed / 2, s.transform = "scale(0.3) rotateX(-90deg)", n.transform = "scale(1) rotateX(0deg)", h = e, a.transform = "scale(0.3) rotateX(90deg)";
                    break;
                case "rotate3d":
                    e = this.options.animSpeed / 2, s.transform = "rotate3d( 1, 1, 0, 90deg )", n.transform = "rotate3d( 1, 1, 0, 0deg )", h = e, a.transform = "rotate3d( 1, 1, 0, -90deg )"
            }
            return {
                startInProp: s,
                startOutProp: i,
        ...
        _showNext: function(t) {
            ...
            clearTimeout(this.playtimeout), this.playtimeout = setTimeout(function() {
                ...
                for (var i = "random" === t ? Math.floor(Math.random() * o + s) : Math.min(Math.abs(t), o), n = e._getRandom(i, e.showTotal), a = 0; i > a; ++a) {
                    var r = e.$items.eq(n[a]);
        ...
        _replace: function(e) {
            ...
            this.outItems.push(s.clone().css("transition", "none")), a.css(i).prependTo(e);
            var r = this._getAnimProperties(s);
            a.css(r.startInProp), s.css(r.startOutProp), this._setTransition(a, "all", r.animSpeed, r.delay, this.options.animEasingIn), this._setTransition(s, "all", r.animSpeed, 0, this.options.animEasingOut), this._applyTransition(a, r.endInProp, r.animSpeed, function() {
                var e = t(this),
                    s = r.animSpeed === o.options.animSpeed && n(r.endInProp) ? r.animSpeed : 0;
                setTimeout(function() {
                    o.supportTransitions && e.off(o.transEndEventName), e.next().remove(), e.parent().data("active", !1)
                }, s)
            }, 0 === r.animSpeed || n(r.endInProp)), this._applyTransition(s, r.endOutProp, r.animSpeed)
        },
        ...
        _applyTransition: function(e, o, s, i, n) {
            var a = this;
            setTimeout(function() {
                t.fn.applyStyle = a.supportTransitions ? t.fn.css : t.fn.animate, i && a.supportTransitions && (e.on(a.transEndEventName, i), n && i.call(e)), i = i || function() {
                    return !1
                }, e.stop().applyStyle(o, t.extend(!0, [], {
                    duration: s + "ms",
                    complete: i
                })), a.options.replaceItem(e)
            }, 25)
        }
    };
    var l = function(t) {
